                            ...
                            <form action="login_back.php" method="POST">	
                                <div class="row">	
                                    <div class="col-sm-12 col-md-10 col-md-offset-1 ">	
                                        ...
                                        <a href="./login-back.php"><input type="button" class="btn btn-info btn-lg btn-block" name="submit" value="Đăng ký" style="margin-top: 20px; background-color: chocolate;"></a>
                                    </div><!-- /col -->	
                                </div><!-- /row -->	
                            </form>	
                        </div><!-- /panel-body -->	
