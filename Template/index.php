    ...
    <header class="header-section">
        <div class="header-top">
            <div class="container">
                ...
                <div class="ht-right">
                    <a href="../user/login.php" class="login-panel"><i class="fa fa-user"></i>Login</a>
            ...
            <div class="row">
                <div class="col-lg-12 order-1 order-lg-2">
                    <div class="product-list">
                        <div class="row">
                        <?php
                                    $sql = "SELECT id,image,name,price,category_id FROM products WHERE status = 0";
                        ...
                        ?>   
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="<?php echo $thumbImage; ?>" alt="" width="100%" height="300">
                                    ...
                                    <div class="pi-text">
                                        ...
                                        <a href="../shop-detail.php?id=<?php echo $kq['id']; ?>">
